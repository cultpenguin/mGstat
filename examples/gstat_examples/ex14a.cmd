...
#
data(zinc.at.0): 'zincat0.eas', x=1, y=2, v=3, X=4, log,  min=20, max=40, radius=1000;  # where part_a = 0
data(zinc.at.1): 'zincat1.eas', x=1, y=2, v=3, X=4, log,  min=20, max=40, radius=1000;  # where part_a = 1
