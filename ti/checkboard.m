% checkboard: create a 1D-3D checkerboard image
%
% Call:
%   C = checkboard(n,w)   
%   n: nubver of pixels per dimension
%   w: width of each checker board (def, w=1);
%
% Example
%   C = checkboard(80); % 1D with checkboard size 1
%   C = checkboard([80 80 80],8) % 3D with checkboard size w=8
%   C = checkboard([80 80],8) % 2D 
% 
% Using:  http://matlabtricks.com/post-31/three-ways-to-generate-a-checkerboard-matrix
function C = checkboard(n,w,mod_val);
